                ...
                <div class="col-auto">
                     <div class="page-utilities">
                        <div class="row g-2 justify-content-start justify-content-md-end align-items-center">
                            ...
                            <div class="col-auto">						    
                                <a class="btn app-btn-secondary" href="{{route('create_config')}}">
                                    
                                    Ajouter un un configuration
                                </a>
                            </div>
                        </div><!--//row-->
                    </div><!--//table-utilities-->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="cell"><span class="truncate">
                                                @if ($configuration->type =="PAYEMENT_DATE")
                                                Date de payement
                                                @endif
                                            ...
                                            <td class="cell text-center">
                                                <a class="btn-sm app-btn-secondary" href="{{route('delete_config',$configuration->id)}}">Supprimer</a>
                                            </td>
                                        </tr> 
                                        - @empty
                                           <td colspan="4">Aucune configuration Ajouter</td> 
                                        @endforelse 
                                    </tbody>
                                </table>
